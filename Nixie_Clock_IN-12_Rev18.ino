...
NTPClient timeclient(ntpUDP, settings.ntpServerName, settings.utcOffset, 60000);

// WiFi functions
WiFiTask wifitask(&nixie, &timetask, &i2c, &timeclient, &server, &settings, &fade);
